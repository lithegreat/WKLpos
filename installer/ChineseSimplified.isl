...
WizardSelectDir=选择安装路径
SelectDirDesc=您想将 [name] 安装到哪个文件夹？
SelectDirLabel3=安装程序将把 [name] 安装到下列文件夹中。
SelectDirBrowseLabel=点击“下一步”继续。如果您想选择其他路径，请点击“浏览”。
DiskSpaceGBLabel=至少需要有 [gb] GB 的可用磁盘空间。
DiskSpaceMBLabel=至少需要有 [mb] MB 的可用磁盘空间。
CannotInstallToNetworkDrive=安装程序无法安装到一个网络驱动器。
CannotInstallToUNCPath=安装程序无法安装到一个 UNC 路径。
InvalidPath=您必须输入一个带驱动器盘符的完整路径，例如：%n%nC:\WanKePos
InvalidDrive=您选定的驱动器不存在或不能访问。请选择其他位置。
...
SelectTasksLabel2=选择您希望在安装 [name] 时执行的附加任务，然后点击“下一步”。
...
WizardReady=准备安装
ReadyLabel1=安装程序准备就绪，即将开始安装 [name] 到您的计算机。
ReadyLabel2a=点击“安装”开始安装。如果您想检查或修改任何设置，请点击“上一步”。
...
ErrorCloseApplications=安装程序无法自动关闭所有应用程序。建议您在继续之前，关闭正在运行的相关程序。
PrepareToInstallNeedsRestart=安装程序必须重启您的计算机。计算机重启后，请再次运行安装程序以完成 [name] 的安装。%n%n要立即重启吗？

; *** "Installing" wizard page
WizardInstalling=正在安装
InstallingLabel=正在安装 [name] 到您的计算机，请稍候...

; *** "Setup Completed" wizard page
FinishedHeadingLabel=安装完成
FinishedLabelNoIcons=[name] 已顺利安装完成。
FinishedLabel=[name] 已顺利安装完成。您可以通过桌面或开始菜单图标启动系统。
ClickFinish=点击“完成”退出安装向导。
FinishedRestartLabel=为完成 [name] 的安装，必须重新启动您的计算机。要立即重启吗？
FinishedRestartMessage=为完成 [name] 的安装，必须重新启动您的计算机。%n%n要立即重启吗？
...
StatusClosingApplications=正在关闭冲突程序...
StatusCreateDirs=正在创建安装目录...
StatusExtractFiles=正在解压安装文件...
StatusDownloadFiles=正在下载文件...
StatusCreateIcons=正在创建快捷方式...
StatusCreateIniEntries=正在写入配置...
StatusCreateRegistryEntries=正在注册系统组件...
...
OnlyAdminCanUninstall=仅管理员权限的用户能完成此卸载。
UninstallStatusLabel=正在卸载 %1，请稍候...
UninstalledAll=已顺利从您的计算机中完全移除 %1。
UninstalledMost=%1 卸载完成。部分文件未能被删除，您可以手动删除它们。
UninstalledAndNeedsRestart=为完成 %1 的卸载，需要重启计算机。要立即重启吗？
UninstallDataCorrupted=文件“%1”已损坏。无法卸载。

; *** Uninstallation phase messages
ConfirmDeleteSharedFileTitle=删除共享文件？
ConfirmDeleteSharedFile2=系统检测到下列共享文件已不再有任何程序使用。您希望卸载程序删除此共享文件吗？
SharedFileNameLabel=文件名：
SharedFileLocationLabel=位置：
WizardUninstalling=卸载向导
