...
Write-Host "`n[1/3] 正在发布 WinUI 3 独立免依赖程序..." -ForegroundColor Yellow
...
& $iscc "$rootDir\installer\WanKePosSetup.iss"

if ($LASTEXITCODE -eq 0) {
    $setupFile = Get-Item "$rootDir\output_installer\WanKePos_Setup_v1.0.0.exe"
